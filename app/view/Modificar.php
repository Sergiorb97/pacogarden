...
<body>
    ...
    <div class="contenedor">
        <h1>Modificando tarea Nº: <?= $_REQUEST['tareaid'] ?></h1>
        <form method="POST" action="../controller/ctrlModificar.php">
            <div class="partOne">
                ...
                <p><span style="color:red">*</span>Nombre contacto<input type="text" name="nombrecontacto" value="<?= tomarValor("nombrecontacto") ?>"> <?= VerErrorModificar("nombrecontacto") ?></p>
            ...
            <div class="partTwo">
                ...
                <p>Anotación anterior<input type="text" name="anotacion_anterior" value="<?= tomarValor("anotacion_anterior") ?>"></p>
                <p>Anotación posterior<input type="text" name="anotacion_posterior" value="<?= tomarValor("anotacion_posterior") ?>"></p>
